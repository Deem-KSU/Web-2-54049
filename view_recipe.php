...
<button id="btn-report" <?php if($reported)   echo "disabled"; ?>>🚩 Report</button>
<button id="btn-like"   <?php if($liked)       echo "disabled"; ?>>👍 Like</button>
<button id="btn-fav"    <?php if($favourited)  echo "disabled"; ?>>🤍 Add to favourites</button>
...
<img src="uploads/<?php echo $recipe['photoFileName']; ?>" alt="Recipe Photo">
</div>
...
<div class="creator">
<img src="uploads/<?php echo $recipe['userPhoto']; ?>" alt="Creator Photo">
...
<img src="uploads/<?php echo $comment['photoFileName']; ?>" alt="User Photo">
...
function ajaxAction(btnID, actionName) {
    $("#" + btnID).click(function() {
        var btn = $(this);
        $.ajax({
            url: "ajax_recipe_actions.php",
            type: "POST",
            data: { recipeID: recipeID, action: actionName },
...
ajaxAction("btn-fav",    "favourite");
ajaxAction("btn-like",   "like");
ajaxAction("btn-report", "report");
</script>
